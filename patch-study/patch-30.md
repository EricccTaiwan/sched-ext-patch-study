...
### sched_ext Context
This patch is the architectural centerpiece of the series. Most later patches either harden this implementation or add integrations, examples, and observability around it.
